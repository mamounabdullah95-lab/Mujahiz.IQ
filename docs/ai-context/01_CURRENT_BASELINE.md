...
Baseline ID: `baseline-2026-08-09-claim-foundation-sec-001-approved`
Updated: 2026-08-09
...
- **Verified current fact:** Current GitHub `main`: `f5b34a51576d505b268e6a5e31ca1f6eb8c539b1`, the merge of PR #99.
...
- **Verified current fact:** Current `main` tracks 15 local SQL migrations and 15 focused pgTAP files with **953 planned assertions**. PR #99 exact-head validation applied all 15 migrations and passed all **953/953** assertions in disposable local PostgreSQL; this is local synthetic evidence, not hosted or Production evidence.
...
- **Verified current fact:** Firebase Production remains unchanged and authoritative for the live application. No Firebase or Production data was migrated, exported, seeded, backfilled, or changed by PR #47, PR #48, PR #49, PR #51, PR #54, PR #59, PR #61, PR #62, PR #64, PR #65, PR #66, PR #67, PR #68, PR #69, PR #70, PR #71, PR #72, PR #73, PR #74, PR #75, PR #76, PR #77, PR #78, PR #79, PR #80, PR #81, PR #82, PR #83, PR #85, PR #86, PR #87, PR #88, PR #89, PR #90, PR #91, PR #93, PR #94, or PR #95, PR #96, PR #98, or PR #99.
...
- **Verified current fact:** The authoritative logical PostgreSQL schema design and its first local migration-control/traceability slice are merged; 15 tracked local SQL migrations implement the second local identity, third local Supplier-profile, fourth local category, fifth local administrative-area, sixth local Supplier-location, seventh local Supplier-category assignment, eighth local Supplier-capability, ninth local Supplier-payment-option, tenth local Supplier-contact, eleventh local Supplier-ownership, twelfth local platform-role-assignment, thirteenth local audit-log, fourteenth local REL-foundation, and fifteenth local Claim-foundation slices, while the remaining business/application schema and runtime remain unimplemented.
...
**Claim foundation implemented locally; SEC-001 architecture approved; no RLS, Auth bridge, Claim, or notification runtime exists**

Merged PR #99 implemented exactly the approved empty, fully revoked, local-only `public.supplier_ownership_claims` foundation plus focused pgTAP as the fifteenth slice. Current `main` therefore contains 15 tracked local SQL migrations and 22 physical tables representing 20 implemented Core Phase 1 concepts; 16 remain deferred. PR #95 remains the merged empty REL foundation. On 9 August 2026, the Technical/Data Owner approved [`37_SEARCH_001_POSTGRESQL_SEARCH_TECHNOLOGY_CONTRACT_REVIEW.md`](../supabase-migration/37_SEARCH_001_POSTGRESQL_SEARCH_TECHNOLOGY_CONTRACT_REVIEW.md) Option A: relational filters plus bilingual PostgreSQL FTS first, with no initial `pg_trgm` and no external Phase 1 search service. SEARCH-001 is Resolved for architecture only; no search SQL, extension, index, projection, RPC, RLS, frontend, AI, hosted, data, or runtime work is selected or authorized.
