...
- **Verified current fact:** Current `main` tracks 22 local SQL migrations and 22 focused pgTAP files, with 24 physical PostgreSQL tables, 80 logical concepts, 37 Core Phase 1 concepts, 22 implemented and 15 unimplemented Core Phase 1 concepts, exactly one Claim RLS policy, and zero Claim mutation policies.
