...
Supplier duplicate-index records
...
Claim/ownership-foundation records
...
supplierProfileId and verified ownership.
...
Notifications, messages, quotations, and comparison.

Value measurement.

Catalog Lite and quotation builder.

Auto-Draft before Auto-Send.
