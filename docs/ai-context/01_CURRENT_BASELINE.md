...
- **Verified current fact:** Current `origin/main` tracks 27 local SQL migrations and 27 focused pgTAP files, with 24 physical PostgreSQL tables, 80 logical concepts, 37 Core Phase 1 concepts, 22 implemented and 15 unimplemented Core Phase 1 concepts, exactly three Claim SELECT RLS policies, and zero Claim mutation policies.
...
- **Verified implementation fact:** Of the 37 Core Phase 1 concepts, 22 are implemented locally and 15 remain unimplemented. The first 4 logical concepts use 6 physical tables because `migration_record_mappings` is decomposed across 3 relations; the local SQL foundation now has 24 physical tables, 27 migrations, and 27 pgTAP files. The Reviewer Private-Read Substrate adds no table or logical concept.
...
### PR #126 supplier_claim.reject synchronization
