...
Baseline ID: `baseline-2026-08-08-supplier-contacts-slice-implemented`
Updated: 2026-08-08
...
- **Verified current fact:** Current GitHub `main`: `1849d12dc52ca99f215fd90762948a67b95117c9`.
...
- **Verified current fact:** Current `main` tracks ten local SQL migrations and ten focused pgTAP files. Their declared plans are **60**, **78**, **84**, **118**, **85**, **56**, **54**, **62**, **67**, and **47** assertions respectively (**711 planned assertions**); this static planned total is not a claim that a new combined run was executed for this baseline update.
...
- **Verified current fact:** Firebase Production remains unchanged and authoritative for the live application. No Firebase or Production data was migrated, exported, seeded, backfilled, or changed by PR #47, PR #48, PR #49, PR #51, PR #54, PR #59, PR #61, PR #62, PR #64, PR #65, PR #66, PR #67, PR #68, PR #69, PR #70, PR #71, PR #72, PR #73, PR #74, PR #75, PR #76, PR #77, PR #78, PR #79, or PR #80.
...
- **Verified current fact:** Of the 36 Core Phase 1 concepts, 14 are implemented locally and 22 remain deferred. The first 4 logical concepts use 6 physical tables because `migration_record_mappings` is decomposed across 3 relations; the local SQL foundation has 16 physical tables.
...
**REL-001 Option D is decision-complete; no reliability SQL slice is selected**
