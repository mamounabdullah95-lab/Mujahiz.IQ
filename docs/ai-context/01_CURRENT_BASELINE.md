...
- **Verified current fact:** The authoritative logical PostgreSQL schema design and local migration slices are merged; 27 tracked local SQL migrations implement through the post-#126 reject slice, while remaining business/application schema and runtime remain unimplemented.
