...
- **Verified current fact:** Current GitHub `main`: `a828d5b9668dc7aa517bc7769160ee372fc568a8`, the merge of PR #122 after the merged PR #120 chain. PR #122 reviewed head `076a1fde3e934ad5f61201a7ba56aba4cd36fb54` is an ancestor.
...
- **Verified current fact:** Current `origin/main` tracks 26 local SQL migrations and 26 focused pgTAP files, with 24 physical PostgreSQL tables, 80 logical concepts, 37 Core Phase 1 concepts, 22 implemented and 15 unimplemented Core Phase 1 concepts, exactly three Claim SELECT RLS policies, and zero Claim mutation policies.
...
- **Verified current fact:** The authoritative logical PostgreSQL schema design and local migration slices are merged; 26 tracked local SQL migrations implement through the post-#122 assign-reviewer slice, while remaining business/application schema and runtime remain unimplemented.
...
- **Verified implementation fact:** Of the 37 Core Phase 1 concepts, 22 are implemented locally and 15 remain unimplemented. The first 4 logical concepts use 6 physical tables because `migration_record_mappings` is decomposed across 3 relations; the local SQL foundation now has 24 physical tables, 26 migrations, and 26 pgTAP files. The Reviewer Private-Read Substrate adds no table or logical concept.
...
### PR #122 supplier_claim.assign_reviewer synchronization
