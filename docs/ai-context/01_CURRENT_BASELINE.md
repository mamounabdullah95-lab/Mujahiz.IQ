...
- **Verified current fact:** Current GitHub `main`: `85a68c44e01d8d3bf86bdbf4d71f8092abfb4f3a`, the merge of PR #120 after the merged PR #113–#119 chain.
...
- **Verified implementation fact:** Of the 37 Core Phase 1 concepts, 22 are implemented locally and 15 remain unimplemented. The first 4 logical concepts use 6 physical tables because `migration_record_mappings` is decomposed across 3 relations; the local SQL foundation now has 24 physical tables, 25 migrations, and 25 pgTAP files. The Reviewer Private-Read Substrate adds no table or logical concept.
