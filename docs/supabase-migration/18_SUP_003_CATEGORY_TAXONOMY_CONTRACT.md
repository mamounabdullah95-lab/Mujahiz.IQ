...
- **Fact:** Before this PR, the fourth-slice review concluded that `categories` and `supplier_category_assignments` could not be implemented safely while SUP-003 was Open; it selected no fourth SQL slice.
